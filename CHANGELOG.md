...
## [5.0.0](https://github.com/DarojaAI/gcp-postgres-terraform/compare/v4.0.5...v5.0.0) (2026-06-01)
...
* **validators:** Phase 2 — input validators, examples, and setup automation ([7dadc29](https://github.com/DarojaAI/gcp-postgres-terraform/commit/7dadc29aa2bd7808cf7a8c74454b0101bba8310f))


### Bug Fixes

* add 0.0.0.0/0 to pg_hba.conf for external access ([0331527](https://github.com/DarojaAI/gcp-postgres-terraform/commit/0331527b3f89e32c2c2a944eae689b9624192e05))
* add create_before_destroy to compute instance to prevent 409 race condition ([#54](https://github.com/DarojaAI/gcp-postgres-terraform/issues/54)) ([848935b](https://github.com/DarojaAI/gcp-postgres-terraform/commit/848935bc1735fd1972790bdd595c9cef4a0ec48a))
...
* align NAT data source router/nat naming with gcp-vpc-egress-terraform ([#65](https://github.com/DarojaAI/gcp-postgres-terraform/issues/65)) ([ffb0b4d](https://github.com/DarojaAI/gcp-postgres-terraform/commit/ffb0b4de499235f569104d88e3809630b20914a8))
...
* default backup_bucket_force_destroy to true ([#64](https://github.com/DarojaAI/gcp-postgres-terraform/issues/64)) ([87c6795](https://github.com/DarojaAI/gcp-postgres-terraform/commit/87c67955202ff5511efba06a3914936a580ace42))
...
* expand machine_type validation to include e2-standard-2, e2-standard-4, n2-standard-1, n2-standard-2 (squashed) ([494073a](https://github.com/DarojaAI/gcp-postgres-terraform/commit/494073a8e4a6441c0c0fed2b10a4de0ec77183d2))
...
* **google_compute_instance:** ignore enable_display drift between GCP provider versions ([#66](https://github.com/DarojaAI/gcp-postgres-terraform/issues/66)) ([34cc69d](https://github.com/DarojaAI/gcp-postgres-terraform/commit/34cc69dd2affdbbd5f357f45c1fd60761a5eb3d2))
* **google_compute_instance:** ignore metadata_startup_script in lifecycle ([#67](https://github.com/DarojaAI/gcp-postgres-terraform/issues/67)) ([0005881](https://github.com/DarojaAI/gcp-postgres-terraform/commit/00058811ad44bd4a0d45a99b874eb4bc7bcd483a))
* increase account_id substr limit from 30 to 32 to ensure trailing digit [skip ci] ([b9fbb36](https://github.com/DarojaAI/gcp-postgres-terraform/commit/b9fbb3629f1d85c9bcd75a8d7271050259a79b18))
...
* simpler account_id formula - truncate for names &lt;=30, sha1 suffix for &gt;30 ([d9c79a7](https://github.com/DarojaAI/gcp-postgres-terraform/commit/d9c79a72982b5671b7f3d268595197678e4b4497))
...
* **startup:** escape bash variable for Terraform template rendering ([713a515](https://github.com/DarojaAI/gcp-postgres-terraform/commit/713a515086bffb3ee7994260455beaf6dd57cf1c))
* **startup:** escape sleep_time bash variable for Terraform template ([2fb8f78](https://github.com/DarojaAI/gcp-postgres-terraform/commit/2fb8f78ad7a7daf7f183a4d4a9017eb890840c1c))
* **startup:** resolve health check false failure on port detection ([#71](https://github.com/DarojaAI/gcp-postgres-terraform/issues/71)) ([d2cc4b1](https://github.com/DarojaAI/gcp-postgres-terraform/commit/d2cc4b1106e5edd57fd41df009b5929ffb03164d))
...
* use "${var.vpc_name}-router" and "${var.vpc_name}-nat" to match. ([ffb0b4d](https://github.com/DarojaAI/gcp-postgres-terraform/commit/ffb0b4de499235f569104d88e3809630b20914a8))
...
* use sha1 suffix for account_id when instance_name &gt; 27 chars ([#60](https://github.com/DarojaAI/gcp-postgres-terraform/issues/60)) ([9666721](https://github.com/DarojaAI/gcp-postgres-terraform/commit/96667214fdcd616c31045f789b49925f915d724f))
...
* use single-char sha1 prefix with 30-char limit for GCP SA account_id ([#62](https://github.com/DarojaAI/gcp-postgres-terraform/issues/62)) ([8a5ea88](https://github.com/DarojaAI/gcp-postgres-terraform/commit/8a5ea88f3afe465af40d0b598dabcf581ff5b808))
...
## [4.0.5](https://github.com/DarojaAI/gcp-postgres-terraform/compare/v4.0.4...v4.0.5) (2026-05-08)
